...
//        mcpClients.remove(0);
    ...
    @Bean
    public ChatClient openAiChatClient(OpenAiChatModel openAiChatModel, @Qualifier("syncMcpToolCallbackProvider") ToolCallbackProvider tools, ChatMemory chatMemory){
